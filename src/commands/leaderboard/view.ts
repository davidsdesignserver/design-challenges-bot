import { ActionRowBuilder, ButtonBuilder, ButtonInteraction, ButtonStyle, ChatInputCommandInteraction, Colors, EmbedBuilder, Interaction, InteractionType, SlashCommandBuilder } from 'discord.js';
import { checkAdmin } from '../../checks';
import config from '../../../config.json';
import { getLeaderboard, updateMember } from '../../database/leaderboard';
...
async function handleLeaderboard(interaction: ButtonInteraction | ChatInputCommandInteraction, leaderboardName: string | null, page: number) {
    ...
    const embed = new EmbedBuilder()
        ...
        }, "Change points with /set and /add commands if you are admin.") : "No points set.")
